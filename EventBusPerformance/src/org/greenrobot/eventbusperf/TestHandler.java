...
public abstract class TestHandler {
    ...
    protected final TestHandlerParams params;
    public final AtomicLong exceptionalEventsReceivedCount = new AtomicLong();
    ...
    public TestHandler(Context context, TestHandlerParams params) {
    ...
    protected void waitForReceivedExceptionalEventCount(int expectedExceptionalEventCount) {
        while (exceptionalEventsReceivedCount.get() < expectedExceptionalEventCount) {
            try {
                Thread.sleep(1);
