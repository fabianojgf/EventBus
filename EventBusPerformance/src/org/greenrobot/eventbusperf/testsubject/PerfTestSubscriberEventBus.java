...
import org.greenrobot.eventbusperf.TestSubscriber;
import org.greenrobot.eventbusperf.TestEvent;
import org.greenrobot.eventbusperf.TestSubscriberParams;

public abstract class PerfTestSubscriberEventBus extends TestSubscriber {
    ...
    public PerfTestSubscriberEventBus(Context context, TestSubscriberParams params) {
        super(context, params);
        eventBus = EventBus.builder().eventInheritance(params.isEventInheritance()).addIndex((SubscriberInfoIndex) new MyEventBusIndex())
    ...
    public void prepareTest() {
        try {
            Constructor<?> constructor = subscriberClass.getConstructor(PerfTestSubscriberEventBus.class);
    ...
    private static String getDisplayModifier(TestSubscriberParams params) {
    ...
    public static class Post extends PerfTestSubscriberEventBus {
        public Post(Context context, TestSubscriberParams params) {
            super(context, params);
        }
    ...
    public static class RegisterAll extends PerfTestSubscriberEventBus {
        public RegisterAll(Context context, TestSubscriberParams params) {
            super(context, params);
        }
    ...
    public static class RegisterOneByOne extends PerfTestSubscriberEventBus {
        protected Method clearCachesMethod;

        public RegisterOneByOne(Context context, TestSubscriberParams params) {
            super(context, params);
        }
        ...
        public void runTest() {
            ...
            for (Object subscriber : super.subscribers) {
                ...
                super.eventBus.registerSubscriber(subscriber);
                ...
                time += timeRegister;
                super.eventBus.unregisterSubscriber(subscriber);
                if (canceled) {
                    return;
                }
            }
    ...
    public static class RegisterFirstTime extends RegisterOneByOne {
        ...
        public RegisterFirstTime(Context context, TestSubscriberParams params) {
            super(context, params);
            try {
